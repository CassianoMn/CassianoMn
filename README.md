...
- 👯 Procuro colaborar em **projetos open source e soluções web modernas**.

- 🤔 Estou buscando ajuda com **Melhores práticas em Arquitetura de Software, Banco de Dados e Desenvolvimento Web**.
...
|---------------|-----------------------------------------|-----------------------------------------|
| **OrganizAE** | **Sistema completo e moderno de gestão financeira pessoal e familiar desenvolvido com React, TypeScript, Firebase e IA. Conta com leitura OCR de notas fiscais por IA, gráficos interativos e controle de orçamentos.** | [**Ver Projeto**](https://github.com/CassianoMn/OrganizAE) \| [**Acessar App**](https://organizae-a9590.web.app) |
| **DesapegAuto** | **Plataforma moderna e intuitiva desenvolvida para facilitar a compra e venda de veículos. É direcionada para concessionárias que desejam anunciar seus veículos, conectando-se diretamente a consumidores de maneira fácil, segura e eficiente.** | [**Ver Projeto**](https://github.com/CassianoMn/DesapegAuto) | 
| **GobirabaSystem** | **Sistema web estático, responsivo e intuitivo desenvolvido para a gestão completa de estoque, registro de entradas de produtos e controle de vendas/saídas da Panificação Gobiraba.** | [**Ver Projeto**](https://github.com/CassianoMn/GobirabaSystem) |
